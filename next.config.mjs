...
const nextConfig = {
  ...
  // The forge engine (pipeline/ → src/) dynamically imports the model SDKs and spawns
  // scripts/*.cjs gates via child_process. Keep these server-only packages external so
