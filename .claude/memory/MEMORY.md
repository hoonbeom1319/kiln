...
- [C2 agentic 방향 (다음 개발 기준)](kiln-c2-agentic.md) — 2026-07-10 확정: 엔진 척추 유지 + 실행만 agentic CC 툴루프(터미널 atelier의 웹 재탄생). **착수 ① shoot 렌더 게이트 완료**, 다음=② runAgentic+stream-json. Claude 1급·모델 점진 확장
