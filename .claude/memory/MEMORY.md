...
- [Kiln 개요](kiln-overview.md) — atelier(로컬 하네스)를 웹·SaaS로 옮긴 프로젝트, 근육은 살고 두뇌만 이식
- [모델 전략](kiln-model-strategy.md) — 로컬 우선 BYO-에이전트로 피벗: Gemini 제거, claude-code·codex 감지·선택·실행, 운영자 비용 0
- [로드맵](kiln-roadmap.md) — 3단계, 다음 스텝 = ① Gemini 품질 A/B(provider 추상화 계층으로)
...
- [C2 agentic 방향 (다음 개발 기준)](kiln-c2-agentic.md) — 2026-07-10 확정: 엔진 척추 유지 + 실행만 agentic CC 툴루프(터미널 atelier의 웹 재탄생). **착수 ①(shoot 게이트)·②(runAgentic+stream-json 렌더-인-루프) 완료**, 다음=③ design-verify 적대적 서브에이전트·픽셀 vision. Claude 1급·모델 점진 확장
